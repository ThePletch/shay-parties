...
ActiveRecord::Schema[7.0].define(version: 2023_06_17_172938) do
  ...
  create_table "cohosts", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "event_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["event_id"], name: "index_cohosts_on_event_id"
    t.index ["user_id"], name: "index_cohosts_on_user_id"
  end
  ...
  add_foreign_key "cohosts", "events"
  add_foreign_key "cohosts", "users"
