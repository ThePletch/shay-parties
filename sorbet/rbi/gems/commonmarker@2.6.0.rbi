...
module Commonmarker::Config
  ...
  class << self
    # pkg:gem/commonmarker#lib/commonmarker/config.rb:86
    def process_extension_options(options); end

    # pkg:gem/commonmarker#lib/commonmarker/config.rb:70
    def process_options(options); end

    # pkg:gem/commonmarker#lib/commonmarker/config.rb:86
    def process_parse_options(options); end

    # pkg:gem/commonmarker#lib/commonmarker/config.rb:78
    def process_plugins(plugins); end

    # pkg:gem/commonmarker#lib/commonmarker/config.rb:86
    def process_render_options(options); end

    # pkg:gem/commonmarker#lib/commonmarker/config.rb:103
...
# pkg:gem/commonmarker#lib/commonmarker/config.rb:60
